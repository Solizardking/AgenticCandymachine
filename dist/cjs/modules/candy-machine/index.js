...
exports.CandyMachineClient = exports.GuardBuilder = exports.CandyMachineBuilder = void 0;
const web3_js_1 = require("@solana/web3.js");
const index_js_1 = require("../../utils/index.js");
// ─── Builder ─────────────────────────────────────────────────────────────────
class CandyMachineBuilder {
    config = {
        itemsAvailable: 0,
...
exports.CandyMachineBuilder = CandyMachineBuilder;
// ─── Guard Builder ───────────────────────────────────────────────────────────
class GuardBuilder {
    guards = {};
...
class CandyMachineClient {
    ...
    async createCollection(name, uri, royalties) {
        await (0, index_js_1.sleep)(400);
        return web3_js_1.Keypair.generate().publicKey; // Mock Collection Mint
    }
    async deploy(config, collectionMint) {
        await (0, index_js_1.sleep)(600);
        const cmKey = web3_js_1.Keypair.generate().publicKey;
        return {
            candyMachine: cmKey,
    ...
    async addItems(candyMachine, items) {
        await (0, index_js_1.sleep)(items.length * 2); // Simulate processing time
        return items.length;
    }
    async mint(candyMachine, group) {
        await (0, index_js_1.sleep)(500);
        const nftMint = web3_js_1.Keypair.generate().publicKey;
        return {
            nft: nftMint,
