...
exports.PassportFactory = void 0;
...
class PassportFactory {
    ...
    buildBundle(dna, art, token) {
        ...
        const rootMint = web3_js_1.Keypair.generate().publicKey;
        const rootNFT = {
            name: dna.name,
            mint: rootMint,
            metadata: {
        ...
        for (const cap of dna.capabilities) {
            const capMint = web3_js_1.Keypair.generate().publicKey;
            const capNFT = {
            ...
            childrenPointers.push({
                ...
                uri: (0, index_js_1.buildPointerUri)(capMint, 1, cap.action || "execute"),
            });
        }
        ...
        const tree = {
            ...
            depth: 0,
            agentContext: {
                dnaHash: dna.dnaHash || (0, index_js_1.sha256)(dna.name),
                tier: dna.tier,
