...
export type SdkEventType = "pipeline:started" | "pipeline:phase" | "pipeline:completed" | "pipeline:error" | "dna:created" | "art:generating" | "art:generated" | "art:uploaded" | "token:creating" | "token:created" | "passport:building" | "passport:built" | "candy-machine:creating" | "candy-machine:created" | "candy-machine:minting" | "candy-machine:minted" | "recursive:tree-built" | "*";
